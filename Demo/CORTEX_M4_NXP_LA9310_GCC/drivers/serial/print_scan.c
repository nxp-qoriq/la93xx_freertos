 ...
 *  otherwise under any patents or trademarks of the copyright holders.
 *  This software is provided on an "AS IS" basis and without warranty.
 *
 *  To the maximum extent permitted by applicable law, the copyright
 *  holders DISCLAIMS ALL WARRANTIES WHETHER EXPRESS OR IMPLIED, INCLUDING
 ...
 *  SHALL the copyright holders BE LIABLE FOR ANY DAMAGES WHATSOEVER
 *  (INCLUDING WITHOUT LIMITATION, DAMAGES FOR LOSS OF BUSINESS PROFITS,
 *  BUSINESS  INTERRUPTION, LOSS OF BUSINESS INFORMATION, OR OTHER
 *  PECUNIARY LOSS) ARISING OF THE USE OR INABILITY TO USE THE SOFTWARE.
 *
 *  The copyright holders assumes no responsibility for the maintenance and support
 *  of this software
 ********************************************************************/
 ...
 */
static int32_t mknumstr( char * numstr,
                         void * nump,
                         int32_t neg,
                         int32_t radix,
                         bool use_caps );
 ...
 * @return Length of the converted string.
 */
    static int32_t mkfloatnumstr( char * numstr,
                                  void * nump,
                                  int32_t radix,
...
static void fput_pad( int32_t c,
                      int32_t curlen,
                      int32_t field_width,
                      int32_t * count,
...
#else
    static int n_putchar( PUTCHAR_FUNC func_ptr,
                          int chacter,
                          void * p,
                          int * max_count )
    {
...
#endif /* if !defined( PRINT_MAX_COUNT ) */
        ...
        switch( c = *++p )
        {
            ...
            case 'i':
                ...
                else
                {
                    ...
                    {
                        fput_pad( ' ', vlen, field_width, &count, func_ptr, farg,
                                  &max_count );
                ...
                goto cont_xd;
                    ...
                    case 'F':
                        ...
                        goto cont_xd;
                #endif /* if defined( PRINTF_FLOAT_ENABLE ) */
            case 'x':
                use_caps = false;
                    ...
                    case 'l':
                        ...
                        break;
                            ...
                            case 'L':
                                ...
                                c++;
                                break;
                        #endif /* if defined( SCANF_FLOAT_ENABLE ) */
                    case '0':
                    case '1':
                    case '2':
                    case '3':
